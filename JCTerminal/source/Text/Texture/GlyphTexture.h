...
namespace jct
{
	...
	public:
		...
		void assign(size_type _width, size_type _height, std::initializer_list<value_type> _vals)
		{
			...
			this->assign(_width, _height, _vals.begin(), _vals.end());
		};
		...
		void fill(const size_type _x, const size_type _y, const GlyphTexture& _texture)
		{
		...
		explicit GlyphTexture(size_type _width, size_type _height) :
